 ...
 * @author sasan
 */
public class Book extends Product implements BookStoreSpecification
{
    ...
    public Book(double price, String productName, String publisherName, int totalInInventory, int id)
    {
    ...
    @Override
    public void setTotalItems(int books)
    {
        if(books < 0)
        {
